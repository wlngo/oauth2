...
import top.wei.oauth2.security.login.captcha.provider.CaptchaAuthenticationProvider;
import top.wei.oauth2.security.login.filter.AbstractLoginFilterConfigurer;
import top.wei.oauth2.security.login.captcha.filter.CaptchaAuthenticationFilter;
